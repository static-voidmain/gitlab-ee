...
build_image images/gradle/Dockerfile "${registry}/gradle:jdk8" --build-arg BASE_IMAGE=gradle:8.14.4-jdk8-corretto
build_image images/gradle/Dockerfile "${registry}/gradle:jdk17" --build-arg BASE_IMAGE=gradle:9.3.1-jdk17
build_image images/gradle/Dockerfile "${registry}/gradle:jdk21" --build-arg BASE_IMAGE=gradle:9.3.1-jdk21
...
build_image images/shell-tools/Dockerfile "${registry}/shell-tools:2026.05"
